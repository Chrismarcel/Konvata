...
class CurrencyConverter {
  constructor(currency_pair, value) {
    ...
    const selectCurrencyList = Array.from(
      document.querySelectorAll(".convert__currency-list")
    );
  }
  ...
  static init() {
    ...
    document
      .querySelector(".toggle-currency__switch")
